...
@safe void drawBoard(IFImage img, ScoreboardConfig config)
{
    ...
    const PlayerConfig[4] players = [
        config.player1, config.player2, config.player3, config.player4
    ];

    const Area[][4] areas_name = [
        Areas.player1_name, Areas.player2_name, Areas.player3_name,
        Areas.player4_name
    ];

    const Area[][4] areas_bar = [
        Areas.player1_bars, Areas.player2_bars, Areas.player3_bars,
        Areas.player4_bars
    ];
